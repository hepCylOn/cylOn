...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  std::atomic<int> CountValidatorFromHits::allEvents{0};
  std::atomic<int> CountValidatorFromHits::goodEvents{0};
  std::atomic<int> CountValidatorFromHits::sumVertexDifference{0};
  std::mutex CountValidatorFromHits::sumTrackDifferenceMutex;
  float CountValidatorFromHits::sumTrackDifference = 0;
...
DEFINE_FWK_ALPAKA_MODULE(CountValidatorFromHits);
