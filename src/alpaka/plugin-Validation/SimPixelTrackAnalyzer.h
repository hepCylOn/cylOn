...
namespace simdoublets {
  ...
  struct HistVectors {
    std::vector<double> vecInnerZ;
    std::vector<double> vecOuterZ;
    std::vector<double> vecInnerR;
    std::vector<double> vecOuterR;
    std::vector<double> vecDZ;
    std::vector<double> vecDR;
    std::vector<double> vecDPhi;
    std::vector<double> vecZ0;
    std::vector<double> vecCurvature;
    std::vector<double> vecPT;
    std::vector<int> vecIDPhi;
    std::vector<int> vecLayerPairId;

    std::vector<double> vecCAThetaCut;
    std::vector<double> vecdcaCut;
    std::vector<double> vechardCurvCut;
    std::vector<double> vecdCurvCut;
    std::vector<double> veccurvRatioCut;
    std::vector<int> vecInnerLayerId;
    std::vector<int> vecInnerNeighborsInnerLayerId;
  };
}  // namespace simdoublets
...
public:
  explicit SimPixelTrackAnalyzer(edm::ProductRegistry& reg);
...
//   // (layer pairs, starting pairs, minimum number of hits) ignoring all cuts on doublets/connections and returns if it was able to find one
  ...
  const edm::EDGetTokenT<ParticleSimpleSoA> particles_getToken_;
  const edm::EDGetTokenT<TrackingRecHitSimpleSoA> hits_getToken_;
...
//   const int maxDYPred_;
  ...
  uint32_t totalDoublets;
  uint32_t totalPassedDoublets;

  simdoublets::HistVectors vectors;

  std::vector<double> binsInnerZ;
  std::vector<double> binsOuterZ;
  std::vector<double> binsInnerR;
  std::vector<double> binsOuterR;
  std::vector<double> binsDZ;
  std::vector<double> binsDR;
  std::vector<double> binsDPhi;
  std::vector<double> binsZ0;
  std::vector<double> binsCurvature;
  std::vector<double> binsPT;
  std::vector<double> binsIDPhi;

  std::vector<double> binsCAThetaCut;
  std::vector<double> binsdcaCut;
  std::vector<double> binshardCurvCut;
  std::vector<double> binsdCurvCut;
  std::vector<double> binscurvRatioCut;

  std::vector<std::vector<uint32_t>> histoInnerZ;
  std::vector<std::vector<uint32_t>> histoOuterZ;
  std::vector<std::vector<uint32_t>> histoInnerR;
  std::vector<std::vector<uint32_t>> histoOuterR;
  std::vector<std::vector<uint32_t>> histoDZ;
  std::vector<std::vector<uint32_t>> histoDR;
  std::vector<std::vector<uint32_t>> histoDPhi;
  std::vector<std::vector<uint32_t>> histoZ0;
  std::vector<std::vector<uint32_t>> histoCurvature;
  std::vector<std::vector<uint32_t>> histoPT;
  std::vector<std::vector<uint32_t>> histoIDPhi;

  std::vector<std::vector<uint32_t>> histoCAThetaCut;
  std::vector<std::vector<uint32_t>> histodcaCut;
  std::vector<uint32_t> histohardCurvCut;
  std::vector<uint32_t> histodCurvCut;
  std::vector<uint32_t> histocurvRatioCut;
