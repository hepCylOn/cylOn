#ifndef AlpakaCore_OneToManyAssoc_h
#define AlpakaCore_OneToManyAssoc_h
...
namespace cms {
    ...
    public:
        ...
        using size_type = typename FlexiStorageBase::size_type;
        using value_type = I;
        ...
        constexpr auto size() const { return off[totOnes() - 1]; }
        constexpr auto size(size_type b) const { return off[b + 1] - off[b]; }
