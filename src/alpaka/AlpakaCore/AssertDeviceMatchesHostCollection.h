#ifndef AlpakaCore_AssertDeviceMatchesHostCollection_h
#define AlpakaCore_AssertDeviceMatchesHostCollection_h
...
#endif  // AlpakaCore_AssertDeviceMatchesHostCollection_h