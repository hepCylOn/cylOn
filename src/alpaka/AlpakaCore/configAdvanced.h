#ifndef AlpakaCore_configAdvanced_h
#define AlpakaCore_configAdvanced_h
...
#define ALPAKA_TYPE_ALIAS_NAME(TYPE) STRINGIFY(ALPAKA_TYPE_ALIAS(TYPE))
...
#endif  // AlpakaCore_configAdvanced_h
