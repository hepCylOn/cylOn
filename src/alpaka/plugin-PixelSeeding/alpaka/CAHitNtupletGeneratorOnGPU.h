#ifndef plugin_PixelSeeding_alpaka_CAHitNtupletGeneratorOnGPU_h
#define plugin_PixelSeeding_alpaka_CAHitNtupletGeneratorOnGPU_h
...
#endif  // plugin_PixelSeeding_alpaka_CAHitNtupletGeneratorOnGPU_h
