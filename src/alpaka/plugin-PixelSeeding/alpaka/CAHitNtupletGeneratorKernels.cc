...
namespace ALPAKA_ACCELERATOR_NAMESPACE {
  ...
  CAHitNtupletGeneratorKernels<TrackerTraits>::CAHitNtupletGeneratorKernels(Params const &params,
    ...
    std::cout << "- outerHits + 1  = " << outerHits + 1 << std::endl;
#endif
    ...
    device_hitPhiView_ = {device_hitPhiHist_->data(), nullptr, device_phiBinnerStorage_->data(), cms::alpakatools::kDynamicSize, nHits};
...
//                                                             *reinterpret_cast<uint32_t*>(device_storage_.data() + 2))}
    ...
    device_extraStorage_ =
        cms::alpakatools::make_device_buffer<cms::alpakatools::AtomicPairCounter::DoubleWord[]>(queue, 1u);
    device_hitTuple_apc_ = reinterpret_cast<cms::alpakatools::AtomicPairCounter *>(device_extraStorage_->data());
    device_nCells_ = cms::alpakatools::make_device_buffer<uint32_t[]>(queue, 1u);
    device_nTriplets_ = cms::alpakatools::make_device_buffer<uint32_t[]>(queue, 1u);
    device_nCellTracks_ = cms::alpakatools::make_device_buffer<uint32_t[]>(queue, 1u);
  ...
  */
  ...
  template class CAHitNtupletGeneratorKernels<pixelTopology::ColliderMLPhase2>;
  template class CAHitNtupletGeneratorKernels<pixelTopology::ColliderMLPixelPlusShortStripsPhase2>;
  template class CAHitNtupletGeneratorKernels<pixelTopology::ColliderMLAllTrackerPhase2>;
