#ifndef PixelSeeding_alpaka_HelixFit_h
#define PixelSeeding_alpaka_HelixFit_h
...
#include "plugin-PixelSeeding/alpaka/FitResult.h"
...
#endif  // PixelSeeding_alpaka_HelixFit_h
