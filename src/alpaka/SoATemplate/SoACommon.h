#ifndef SoATemplate_SoACommon_h
#define SoATemplate_SoACommon_h
...
//   using fmt::format;
// #else
//   #error "No <format> or <fmt/core.h> available!"
// #endif
...
#else
#define SOA_THROW_OUT_OF_RANGE(A, I, R) \
  { throw std::out_of_range("index out of range!!"); }//std::format("{}: index {} out of range {}", (A), (I), (R))); }
#endif
