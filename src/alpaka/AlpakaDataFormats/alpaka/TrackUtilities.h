#ifndef AlpakaDataFormats_TrackUtilities_h
#define AlpakaDataFormats_TrackUtilities_h
...
namespace pixelTrack {
  ...
  template <typename TrackerTraits>
  struct QualityCutsT<TrackerTraits, pixelTopology::isColliderMLPhase1Topology<TrackerTraits>> {
    using TrackSoAView = reco::TrackSoAView;
    using TrackSoAConstView = reco::TrackSoAConstView;
    float chi2Coeff[4];
    float chi2MaxPt;  // GeV
  ...
  template <typename TrackerTraits>
  struct QualityCutsT<TrackerTraits, pixelTopology::isColliderMLPixelPlusShortStripsPhase2Topology<TrackerTraits>> {
    using TrackSoAView = reco::TrackSoAView;
    using TrackSoAConstView = reco::TrackSoAConstView;
  ...
  template <typename TrackerTraits>
  struct QualityCutsT<TrackerTraits, pixelTopology::isColliderMLAllTrackerPhase2Topology<TrackerTraits>> {
    using TrackSoAView = reco::TrackSoAView;
    using TrackSoAConstView = reco::TrackSoAConstView;
