...
//   globalPositionVector_.push_back(recHit.globalPosition() - beamSpotPosition_);
  globalPositionVector_.push_back({recHits[recHitId].xGlobal() - beamSpotPosition_.x,recHits[recHitId].yGlobal() - beamSpotPosition_.y,recHits[recHitId].zGlobal() - beamSpotPosition_.z});
