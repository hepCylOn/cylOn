#ifndef AlpakaDataFormats_PixelTrackSoA_h
#define AlpakaDataFormats_PixelTrackSoA_h
...
namespace pixelTrack {
  ...
  public:
    ...
    using HitContainer = cms::alpakatools::OneToManyAssoc<hindex_type, S, 8 * S>;
...
#else
  constexpr uint32_t maxNumber() { return 256 * 1024; }
#endif
...
#endif  // AlpakaDataFormats_PixelTrackSoA_h
