...
constexpr float minz_vals[nPairs] = {
    ...
    //1,  2     1,  4   1,  11      
      1.*-35.0, 1.*6.0, 3.*-24.0, 
    //2,  3     2,  4    2,  11      
      3.*-18.0, 1.*11.0, 3.*-24.0,
      
    //4,  5    5,  6    6,  7    7,  8    8,  9    9,  10      
      1.*23.0, 1.*30.0, 1.*39.0, 1.*50.0, 1.*65.0, 1.*82.0, 
    //11, 12    12, 13    13, 14    14, 15    15, 16    16, 17      
      3.*-28.0, 3.*-35.0, 3.*-44.0, 3.*-55.0, 3.*-70.0, 3.*-109.0, 
      
    //0,  2     0,  5   0,  12    0,  6    0,  13      
      1.*-17.0, 1.*7.0, 1.*-24.0, 1.*11.0, 1.*-24.0,
    //1,  3     1,  5   1,  12    1,  6    1,  13       
      1.*-17.0, 1.*9.0, 1.*-24.0, 1.*13.0, 1.*-24.0, 
      
    //4,  6    5,  7    6,  8    7,  9    8,  10      
      1.*23.0, 1.*30.0, 1.*39.0, 1.*50.0, 1.*65.0, 
    //11, 13    12, 14    13, 15    14, 16    15, 17      
      3.*-28.0, 3.*-35.0, 3.*-44.0, 3.*-55.0, 3.*-70.0
...
constexpr float maxz_vals[nPairs] = {
    ...
    //0,  2    0,  5    0,  12   0,  6    0,  13 
      1.*17.0, 1.*24.0, 1.*-7.0, 1.*24.0, 1.*-11.0,
    //1,  3    1,  5    1,  12   1,  6    1,  13
      1.*17.0, 1.*24.0, 1.*-9.0, 1.*24.0, 1.*-13.0,
...
constexpr float maxr_vals[nPairs] = {
  ...
  //0,  2    0,  5   0,  12  0,  6   0,  13 
    1.*10.0, 1.*5.0, 1.*5.0, 1.*5.0, 1.*5.0,
  //1,  3    1,  5   1,  12  1,  6   1,  13
    1.*12.0, 1.*8.0, 1.*8.0, 1.*8.0, 1.*8.0,

  //4,  6   5,  7   6,  8   7,  9   8,  10
    1.*9.0, 1.*9.0, 1.*9.0, 1.*8.0, 1.*8.0,
  //11, 13  12, 14  13, 15  14, 16  15, 17
    1.*9.0, 1.*9.0, 1.*9.0, 1.*8.0, 1.*8.0
...
constexpr float caDCACuts_vals[nLayers] = {1.*0.15,  //BPix1
                                           1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25,
                                           1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25, 1.*0.25};
constexpr float caThetaCuts_vals[nLayers] = {1.*0.002, 1.*0.002, 1.*0.002, 1.*0.002,  // BPix
                                             1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003,
                                             1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003, 1.*0.003};
