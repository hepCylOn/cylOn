...
constexpr int16_t phicuts[nPairs]{
      ...
      phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p05,
      phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p05, phi0p07, phi0p07, phi0p07, phi0p07, phi0p07, phi0p07, phi0p07,
...
// };
constexpr float minz_vals[nPairs] = {
      100.*-17.0, 0.01*4.0,   100.*-22.0, 100.*-17.0, 0.01*6.0,   100.*-22.0, 100.*-18.0, 0.01*11.0,  100.*-22.0,  0.01*23.0,   0.01*30.0,   0.01*39.0,   0.01*50.0,   0.01*65.0,
      0.01*82.0, 100.*-28.0, 100.*-35.0, 100.*-44.0, 100.*-55.0, 100.*-70.0, 100.*-109.0, 100.*-17.,   0.01*7.0,    100.*-22.0,  0.01*11.0,   100.*-22.0,
      100.*-17.0, 0.01*9.0,   100.*-22.0, 0.01*13.0,  100.*-22.0, 0.01*23.0,
      0.01*30.0,  0.01*39.0,  0.01*50.0,  0.01*65.0, 100.*-28.0, 100.*-35.0, 100.*-44.0,  100.*-55.0,  100.*-70.0};
...
// };
constexpr float maxz_vals[nPairs] = {
      100.*17.0, 100.*22.0,  0.01*-4.0,  100.*17.0,  100.*22.0,  0.01*-6.0,  100.*18.0,  100.*22.0,  0.01*-11.0,  100.*28.0,   100.*35.0,   100.*44.0,   100.*55.0,   100.*70.0,
      100.*113.0, 0.01*-23.0, 0.01*-30.0, 0.01*-39.0, 0.01*-50.0, 0.01*-65.0, 0.01*-87.0, 100.*17.0,   100.*22.0,   0.01*-7.0,   100.*22.0,   0.01*-10.0,
      100.*17.0, 100.*22.0,  0.01*-9.0,  100.*22.0,  0.01*-13.0, 100.*28.0,
      100.*35.0, 100.*44.0,  100.*55.0,  100.*70.0, 0.01*-23.0, 0.01*-30.0, 0.01*-39.0,  0.01*-50.0,  0.01*-65.0};
...
// };
constexpr float maxr_vals[nPairs] = {10.*5.0, 10.*5.0, 10.*5.0, 10.*7.0, 10.*8.0, 10.*8.0, 10.*7.0, 10.*7.0, 10.*7.0, 10.*6.0, 10.*6.0, 10.*6.0, 10.*6.0, 10.*5.0,
                                     10.*6.0, 10.*6.0, 10.*6.0, 10.*6.0, 10.*6.0, 10.*5.0, 10.*6.0, 10.*5.0, 10.*5.0, 10.*5.0, 10.*5.0, 10.*5.0,
                                     10.*5.0, 10.*8.0, 10.*8.0, 10.*8.0, 10.*8.0, 10.*9.0,
                                     10.*9.0, 10.*9.0, 10.*8.0, 10.*8.0, 10.*9.0, 10.*9.0, 10.*9.0, 10.*8.0, 10.*8.0};
...
// };
constexpr float caDCACuts_vals[nLayers] = {10*0.15,  //BPix1
                                           10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25,
                                           10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25, 10*0.25};
...
// };
constexpr float caThetaCuts_vals[nLayers] = {1.2*0.002, 1.2*0.002, 1.2*0.002, 1.2*0.002,  // BPix
                                             1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003,
                                             1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003, 1.2*0.003};
