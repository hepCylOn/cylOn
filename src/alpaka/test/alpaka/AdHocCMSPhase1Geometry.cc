...
// constexpr int16_t phi0p05 = int16_t(1.0*522);
// constexpr int16_t phi0p06 = int16_t(1.0*626);
// constexpr int16_t phi0p07 = int16_t(1.0*730);
...
constexpr float minz_vals[nPairs] = {
    ...
    //0,  1     0,  4     0,  11
      2.0*-34.0,    2.0*4.0,      2.0*-48.0, 
    //1,  2     1,  4     1,  11      
      2.0*-44.0,    2.0*6.0,      2.0*-72.0, 
    //2,  3     2,  4     2,  11      
      2.0*-54.0,    2.0*11.0,     2.0*-96.0,
      
    //4,  5     5,  6     6,  7    7,  8    8,  9    9,  10      
      2.0*23.0,     2.0*30.0,     2.0*39.0,    2.0*50.0,    2.0*65.0,    2.0*82.0, 
    //11, 12    12, 13    13, 14   14, 15   15, 16   16, 17      
...
constexpr float maxz_vals[nPairs] = {
    ...
    //0,  1     0,  4     0,  11
      2.0*34.0,     2.0*48.0,     2.0*-4.0,
    //1,  2     1,  4     1,  11
      2.0*44.0,     2.0*72.0,     2.0*-6.0,
    //2,  3     2,  4     2,  11
      2.0*54.0,     2.0*96.0,     2.0*-11.0,
