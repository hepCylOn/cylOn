#ifndef CondFormats_interface_alpaka_SiPixelGainCalibrationForHLTUtilities_h
#define CondFormats_interface_alpaka_SiPixelGainCalibrationForHLTUtilities_h
...
#endif  // CondFormats_interface_alpaka_SiPixelGainCalibrationForHLTUtilities_h
