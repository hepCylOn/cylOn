#ifndef CondFormats_pixelCPEforDevice_h
#define CondFormats_pixelCPEforDevice_h
...
#include "AlpakaDataFormats/SiPixelHitStatus.h"
...
#endif  // CondFormats_pixelCPEforDevice_h
