#ifndef SiPixelClusterizer_alpaka_PixelClustering_h
#define SiPixelClusterizer_alpaka_PixelClustering_h
...
#include "Framework/DeviceGlobal.h"
...
#endif  // SiPixelClusterizer_alpaka_PixelClustering_h